...
export default function Online() {
    return (
        ...
        <h3 className="goSkypeH">
            ...
            <a className="goSkype" href='https://join.skype.com/fihu50Yii3O3'>Перейти у Skype</a>
        </h3>
        ...
        */}
        ...
        <h4 className="goSkypeH3" align="left">
            ...
            <br/>
            2) Написати у чат групи прізвище учня. 
            <br/><br/>
            Вчитель надішле вам відео з уроком в особисті повідомлення. З питаннями щодо пропущених тем можете звертатись до вчителя у вайбері.
